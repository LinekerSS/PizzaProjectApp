    ...
    return (
        <View style={styles.container}>
            ...
            <View style={styles.qtdContainer}>
                ...
                <TextInput style={[styles.input, { width: '60%', textAlign: 'center'}]} placeholder='1' placeholderTextColor="#f0f0f0" keyboardType="numbers-and-punctuation" value={amount} onChangeText={setAmount}/>
            </View>
